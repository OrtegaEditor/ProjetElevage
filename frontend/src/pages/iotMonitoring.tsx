...
import {
    ...
    switch (type) {
        ...
        case "light": return <Droplet className="w-5 h-5" />;
        case "ammoniac": return <Wind className="w-5 h-5" />;
    ...
    <div className="space-y-6">
        ...
        <CardContent>
            ...
            <LineChart data={liveData}>
                ...
                <Tooltip />
                <Legend />
                <Line yAxisId="left" type="monotone" dataKey="temp" stroke="#FB8C00" strokeWidth={2} name="Température (°C)" dot={{ r: 4 }} />
                <Line yAxisId="right" type="monotone" dataKey="light" stroke="#1E88E5" strokeWidth={2} name="lumiere (%)" dot={{ r: 4 }} />
                <Line yAxisId="right" type="monotone" dataKey="nh3" stroke="#9C27B0" strokeWidth={2} name="Ammoniac (ppm)" dot={{ r: 4 }} />
            </LineChart>
            </ResponsiveContainer>
        </CardContent>
        </Card>
            ...
            <table className="w-full text-sm">
                ...
                {sensors.map((sensor) => (
                    ...
                    <td className="py-3">
                        ...
                        <Button onClick={() => handleView(sensor)} className="p-1.5 bg-blue-100 text-gray-600 hover:bg-gray-50">
                            <Eye className="w-4 h-4" />
                        </Button>
                        <Button onClick={() => handleEdit(sensor)} className="p-1.5 bg-blue-100 text-blue-600 hover:bg-blue-50">
                            <Pencil className="w-4 h-4" />
                        </Button>
                        <Button onClick={() => handleDelete(sensor.id)} className="p-1.5 bg-blue-100 text-red-600 hover:bg-red-50">
